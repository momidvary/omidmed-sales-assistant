...
5. برای پیشنهاد تماس، فوریت را بر اساس urgency_score و urgency_reasons توضیح بده. customer_value فقط ارزش تجاری دستی مشتری است و به‌تنهایی دلیل تماس فوری نیست.
6. تمام مبلغ‌های داده داخلی بر حسب تومان هستند و باید با واحد تومان نوشته شوند.
